/* 运行：sudo ./12864 [字符] 编译：gcc 12864.c -o 12864 -L lib -l wiringPi (需已安装wiringPi) by：WuSiYu
*/
#include <stdio.h>
# include <stdlib.h>
#include <stdint.h>
...
int main (void){
    ...
    WriteWord_LCD12864(0x80,"循环掉电测试");
	printf("循环掉电开始测试\n");
	//WriteWord_LCD12864(0x90,"循环测试次数");
...
{  
	...
	delay(25000);
         ...
         digitalWrite(RELAY, HIGH);
			printf("循环掉电测试结束\n");
			WriteWord_LCD12864(0x90,"循环测试结束");
	while(1)
	{
